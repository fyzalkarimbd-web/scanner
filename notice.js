...
function printNotice() {
    ...
    win.document.write('<style>@import url("https://fonts.maateen.me/solaiman-lipi/font.css"); body{font-family: "SolaimanLipi", Arial, sans-serif; padding: 50px;} #p-inst{text-align:center; font-size:24px; text-transform: uppercase;} #p-addr{text-align:center; margin-bottom:20px; font-size:14px;} .header-info{display:flex; justify-content:space-between; font-size:14px; margin-bottom:30px;}</style>');
