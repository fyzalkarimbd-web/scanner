...
function initDistrictSelector() {
    ...
    select.innerHTML = '<option value="ঢাকা">ঢাকা</option>';
...
function changeDistrict() {
    ...
    dhakaRamadanTimes.forEach(item => {
        if (item.type !== currentType) {
            ...
            body.innerHTML += `<tr class="section-header"><td colspan="5" style="background:#f1f5f9; color:#059669; font-weight:800; padding:10px; border-top: 2px solid #059669;">${currentType} (১০ দিন)</td></tr>`;
        }
    ...
    document.getElementById('today-sehri').innerText = calculateTime(dhakaRamadanTimes[0].s, offset.s);
    document.getElementById('today-iftar').innerText = calculateTime(dhakaRamadanTimes[0].i, offset.i);
    document.getElementById('current-location-info').innerText = `স্থান: ${dist} জেলা | পবিত্র রমজান ১৪৪৭ হিজরি`;
}
